...
export const metadata: Metadata = {
  title: "Snow & Ice Terms and Conditions | Dr. Snow MA",
  ...
  return <>
    ...
    <main>
      ...
      <section className="section terms-section"><div className="shell terms-layout">
        ...
        <article className="term-card"><Snowflake /><div><h2>Included Areas and Service Limitations</h2><p>Pay-per-storm and seasonal prices include driveway snow removal, the primary walkway, and front-step clearing. Dr. Snow reserves the right to delay or skip the driveway, walkway, or steps when extreme cold, weather conditions, or other hazards make service dangerous; when route timing requires moving to the next scheduled customer; when vehicles, objects, snowbanks, or other obstructions have not been cleared; when access is unavailable; or when the area cannot be serviced safely.</p></div></article>
