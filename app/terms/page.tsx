  ...
  return <>
    ...
    <main>
      ...
      <section className="section terms-section"><div className="shell terms-layout">
        ...
        <div className="terms-actions"><p>Questions about these conditions or your property?</p><Link className="button button-primary" href="/#request-service">Request Service</Link></div>
      </div></section>
    </main>
    <Footer />
  </>;
