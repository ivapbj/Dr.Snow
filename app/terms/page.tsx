  ...
  return <>
    ...
    <main>
      ...
      <section className="section terms-section"><div className="shell terms-layout">
        ...
        <article className="term-card"><Snowflake /><div><h2>Walkway and Front-Step Clearing</h2><p>Pay-per-storm and seasonal prices cover driveway snow removal. When conditions are safe and route timing permits before the next scheduled customer, Dr. Snow may also clear the primary walkway and front steps at no additional charge. This is a courtesy service and is not guaranteed.</p></div></article>
