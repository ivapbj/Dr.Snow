      ...
      <section className="section" id="how-it-works">
        <div className="shell">
          ...
          <div className="steps">
            ...
            <article><span>04</span><Snowflake /><h3>We clear the property*</h3><p>Driveway snow removal, the primary walkway, and front steps are included. A standard storm receives one scheduled clearing, subject to safety, access, weather, and route timing.</p></article>
